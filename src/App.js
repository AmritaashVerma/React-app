    ...
    <div className="App">
      ...
      <h5 align="center" class="text-2xl text-gray-900 dark:text-white">
        ...
        <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-white">
          <br></br>
          <button type="button" class="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">The longest text in a button for the gradient effect.</button>
        </p>
    </h5>
